...
const SurveyCard = ({ handleClick }) => {
  return (
    <div className="flex gap-8 flex-wrap">
      <div
        className="xsm:w-[170px] transition-all duration-200 ease-in transform sm:hover:scale-105 hover:-translate-x-2 sm:w-[480px] md:w-[500px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer"
        onClick={handleClick}
      >
        <img
          loading="lazy"
